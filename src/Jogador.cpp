...
namespace Entities
{
    ...
    {
        Jogador::Jogador(coordenadas::vetorfloat pos, Gerenciadores::Gerenciador_grafico* pGraf, Gerenciadores::Gerenciador_colisoes* pGC, const char* pathImagem)
        ...
        Jogador::Jogador() : Personagem(), podePular(false), pulando(false), olhandoParaDireita(false),
            vetVel(0.f, (float)GRAVITY), maxAltura(0.f), cooldownTiro(150.f)
        {
        }
