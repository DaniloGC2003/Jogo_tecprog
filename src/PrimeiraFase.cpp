...
void PrimeiraFase::inicializaFase()
{
	...
	pP = new Entities::Plataforma(coordenadas::vetorfloat(500.f, 200.f), getAnimacao()->getpGraf(), &Colisoes, "texturas_e_fontes/preview.png");
	pP->getAnimacao()->mudaEscala(10.f, 0.8f);
	estaticas.pushEntidade(static_cast<Entities::Entidade*>(pP));

	//inicializando barris:
	pEnt = static_cast<Entities::Entidade*> (new Entities::Barril(coordenadas::vetorfloat(100.f, 265.f), getAnimacao()->getpGraf(), &Colisoes, "texturas_e_fontes/Fishbarrel4.png"));
	estaticas.pushEntidade(pEnt);
	pEnt = static_cast<Entities::Entidade*> (new Entities::Barril(coordenadas::vetorfloat(1100.f, 265.f), getAnimacao()->getpGraf(), &Colisoes, "texturas_e_fontes/Fishbarrel4.png"));
	estaticas.pushEntidade(pEnt);
	pEnt = static_cast<Entities::Entidade*> (new Entities::Barril(coordenadas::vetorfloat(2100.f, 265.f), getAnimacao()->getpGraf(), &Colisoes, "texturas_e_fontes/Fishbarrel4.png"));
	estaticas.pushEntidade(pEnt);
	if (numBarris > 3)
	{
		pEnt = static_cast<Entities::Entidade*> (new Entities::Barril(coordenadas::vetorfloat(3100.f, 265.f), getAnimacao()->getpGraf(), &Colisoes, "texturas_e_fontes/Fishbarrel4.png"));
		estaticas.pushEntidade(pEnt);
	}

	//inicializando lagos:
	pEnt = static_cast<Entities::Entidade*> (new Entities::Lago(coordenadas::vetorfloat(300.f, 290.f), getAnimacao()->getpGraf(), &Colisoes, "texturas_e_fontes/Water.png"));
	estaticas.pushEntidade(pEnt);
	pEnt = static_cast<Entities::Entidade*> (new Entities::Lago(coordenadas::vetorfloat(1300.f, 290.f), getAnimacao()->getpGraf(), &Colisoes, "texturas_e_fontes/Water.png"));
	estaticas.pushEntidade(pEnt);
	pEnt = static_cast<Entities::Entidade*> (new Entities::Lago(coordenadas::vetorfloat(2300.f, 290.f), getAnimacao()->getpGraf(), &Colisoes, "texturas_e_fontes/Water.png"));
	estaticas.pushEntidade(pEnt);
	if (numLagos > 3)
	{
		pEnt = static_cast<Entities::Entidade*> (new Entities::Lago(coordenadas::vetorfloat(3300.f, 290.f), getAnimacao()->getpGraf(), &Colisoes, "texturas_e_fontes/Water.png"));
		estaticas.pushEntidade(pEnt);
	}
