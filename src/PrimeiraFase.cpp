...
PrimeiraFase::PrimeiraFase(coordenadas::vetorfloat pos, Gerenciadores::Gerenciador_grafico* pGraf, const char* caminho):
	...
	tartaruga(coordenadas::vetorfloat(400.f, 110.f), getAnimacao()->getpGraf(), "texturas_e_fontes/Battle_turtle.png", &jogador, &Colisoes)
...
{
	//tbm ver se chegou no fim do mapa
